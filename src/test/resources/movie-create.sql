insert into bootcampdb.movie (id,director,genre,name,release_year)
values (1001,'movie-director 1001','ACTION','movie-name 1001',2015),
       (1002,'movie-director 1002','COMEDY','movie-name 1002',2015);
